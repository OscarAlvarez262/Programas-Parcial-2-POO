...
public class Division extends javax.swing.JFrame {
    ...
    private void btnDividirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDividirActionPerformed
        ...
        if (txtNumero1.getText().equals("") || txtNumero2.getText().equals("")) {
            ...
            if (txtNumero1.getText().equals("0") || txtNumero2.getText().equals("0")) {
                JOptionPane.showMessageDialog(null, "No se puede dividir", "ERROR", JOptionPane.ERROR_MESSAGE);
            } else {
                float A = 0, B = 0, R = 0;
